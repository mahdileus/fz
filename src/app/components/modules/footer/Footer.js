      ...
      <div className=" container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 text-[#112D4E]">
        ...
        <div className="space-y-2 text-center md:text-right">
          ...
          <ul className="space-y-2 text-md text-center md:text-right">
            ...
            <Link href={"/courses"} className="block">دوره‌ها</Link>
        ...
        <h4 className="font-bold text-xl text-center md:text-right font-kalameh">تماس باما</h4>
          <div className="text-sm space-y-4">
            <p className="text-base"><PiPhone className="inline ml-2 text-xl" /> 09925349731</p>
            
            <p className="text-base"><PiClock className="inline ml-2 text-xl"/> ساعت کاری از ساعت 8 صبح تا 10 شب </p>
          </div>
